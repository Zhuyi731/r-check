	...
	function StaticModule() {
		...
		this.initValue = function (staticIPListArray) {
			...
			for (i = 0; i < len; i++) {
				...
				listStr += "<td><div class='ico icon-minus-circled text-style'></div></td>";
				listStr += "</tr>";
		...
		function addStaticList() {
			...
			str += "<td><div class='ico icon-minus-circled text-style'></div></td>";
			str += "</tr>";
	...
	function PortMapModule() {
		...
		this.initValue = function (portListArray) {
			...
			for (i = 0; i < len; i++) {
				...
				str += "<td><div class='ico icon-minus-circled text-style' titile='" + _("Delete") + "'></div></td>";
				str += "</tr>";
			}
			$("#portTbody").html(str);
		};
