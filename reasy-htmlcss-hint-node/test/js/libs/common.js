...
var statusMsg = {
    ...
    "0205": _("The router has obtained a valid IP address but cannot access the Internet. Please try the solutions below one by one.") + "<br/>" + "1. <a id='cloneMac' style='text-decoration:underline;' class='text-success' href='javascript:void(0)'>" + _("Clone MAC address") + "</a>" + _("(MAC Clone will take effect in 30 seconds.)") +
        "<br/>" + _("2. Try another computer and ") + "<a id='toNetwork' style='text-decoration:underline;' class='text-success' href='javascript:void(0)'>" + _("reconfigure the router") + "</a><br/>" + _("3. Please make sure you have applied a valid Internet service. If not, consult your ISP for help"),
    ...
    "1206": _("Connected! You can surf the Internet2."),
